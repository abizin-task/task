...
*
*/
define('APP_BASE_URL', 'https://crm.sieuthiweb.online/');
...
*/
define('APP_ENC_KEY', 'a4e5a6aecf37b0ea7b8e22e83446927d');
 ...
 */
define('APP_DB_USERNAME', 'demoweb_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'demoweb_crm');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'demoweb_crm');
